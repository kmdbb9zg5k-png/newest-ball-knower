  ...
  return (
    <div className="min-h-[calc(100dvh-7rem)] px-4 pb-10 pt-5 text-white sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        {view==='leagues'&&<><section className="relative mb-7 overflow-hidden rounded-[2rem] border border-[#D4AF37]/25 bg-[#080a0d] p-6 shadow-2xl sm:p-9">
