...
export const FantasySeasonAdmin:React.FC<{league:League}>=({league})=>{
  ...
  return <section className="relative mt-5 overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#090c11] p-4 shadow-2xl sm:p-5">
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_12%_10%,rgb(var(--bk-team-primary-rgb)/.22),transparent_32%),radial-gradient(circle_at_92%_18%,rgb(var(--bk-team-secondary-rgb)/.14),transparent_30%),linear-gradient(135deg,rgba(255,255,255,.035),transparent_34%,rgba(0,0,0,.38))]"/>
