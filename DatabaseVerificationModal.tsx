      ...
      <div className="relative w-full max-w-5xl max-h-[92vh] flex flex-col rounded-xl border border-[#D4AF37]/50 bg-[#0A0A0A] text-white shadow-2xl overflow-hidden">
        ...
        <div className="bg-[#D4AF37] text-black px-4 py-1.5 text-[11px] font-mono font-black uppercase flex flex-wrap items-center justify-between tracking-wide shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <span>•</span>
            <span className="font-extrabold tracking-wider">RATING CHECKS: {ratingsReport.ratingsVerifiedCount}/{ratingsReport.totalPlayersChecked}</span>
            <span>•</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-zinc-400">
                Ball Knower Composite ({BALL_KNOWER_RATING_METADATA.ratingSeason}) • {PLAYERS_DATABASE.length} Active Players • All 32 Teams Synchronized
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          {/* TAB: BALL KNOWER ESTIMATE AUDIT */}
          {activeTab === 'ratings' && (
            <div className="space-y-6">
              ...
              <div className="rounded-xl border border-[#D4AF37]/50 bg-gradient-to-r from-[#D4AF37]/15 via-black to-[#00FF00]/10 p-4 sm:p-5 shadow-lg">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-mono font-black text-[#D4AF37] uppercase tracking-wider">Primary Source of Truth: {BALL_KNOWER_RATING_METADATA.ratingSource}</span>
                    ...
                    <p className="text-xs text-zinc-300 max-w-2xl mt-1">
                      Checks cover identity, numeric bounds and source metadata. Ratings are independent Ball Knower estimates, not official league ratings or measured athletic skills. Every player is enriched with <code className="text-[#D4AF37]">overallRating</code>, <code className="text-[#D4AF37]">ratingSource</code>, and <code className="text-[#D4AF37]">ratingSeason</code>.
                    </p>
                  </div>
                    ...
                    <div key={idx} className="rounded-lg border border-white/10 bg-black/60 p-3.5 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between mt-3 pt-2 border-t border-white/10">
                        ...
                        <div className="flex items-center gap-1 text-xs text-[#00FF00] font-mono font-black">
                          ...
                          Estimate: {update.officialOvr} OVR
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                {searchedPlayers.map(player => (
                  ...
                  >
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <div className="text-[9px] uppercase font-bold text-zinc-400">BK OVR</div>
                    </div>
                  </div>
                ))}
              </div>
