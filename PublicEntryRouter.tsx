...
export const PublicEntryRouter:React.FC=()=>{
 ...
 if(!slug)return <App/>;
 return <Suspense fallback={<div className="min-h-screen bg-[#07090c] grid place-items-center text-xs font-black uppercase tracking-[.2em] text-zinc-500">Loading Ball Knower broadcast…</div>}><SpectatorLeagueView slug={slug}/></Suspense>;
};
