...
var STAFF_ART_PROFILES = [
  ...
  { id: "solo-staff-agent-ethan-cole", role: "agent", name: "Ethan Cole", nationality: "American", age: 39, heightInches: 72, weightLbs: 186, visualDirection: "White American man in his late thirties with fair skin, a lean angular face, neatly styled medium-brown hair, light stubble and composed high-stakes negotiating confidence" },
...
async function previewControl(req, res) {
  ...
  if (action === "submit-sample") {
    ...
    const players = SOLO_PLAYERS_DATABASE2.filter((player) => player.team === team).slice(offset, offset + 16);
