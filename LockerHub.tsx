...
export const LockerHub:React.FC=()=>{
 ...
 return <BroadcastStage scene="locker" page="profile" className="relative isolate min-h-[calc(100dvh-7rem)] overflow-hidden px-3 pb-8 pt-4 sm:px-6 sm:pt-6">
  <div aria-hidden="true" className="hidden pointer-events-none fixed inset-0 -z-20 bg-[linear-gradient(180deg,#05070a_0%,#070a0f_44%,#030406_100%)]"/>
  <div aria-hidden="true" className="hidden pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_14%_2%,rgb(var(--bk-team-primary-rgb)/.28),transparent_36%),radial-gradient(ellipse_at_88%_8%,rgb(var(--bk-team-secondary-rgb)/.16),transparent_34%)]"/>
