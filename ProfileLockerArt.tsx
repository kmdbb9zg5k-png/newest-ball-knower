...
function ReferenceArt({ region, className }: { region: string; className?: string }) {
  return <svg className={className} viewBox={region} aria-hidden="true" focusable="false" overflow="hidden"><image href={LOCKER_ATLAS} width="544" height="552"/></svg>;
}
...
export function LockerRatingNumeral({ value }: { value: string }) {
  ...
  return <svg viewBox="0 0 160 104" aria-hidden="true" focusable="false">
