...
const calculateCombineResults = (profile: { name: string; position: string; heightInches: number; weightLbs: number; bodyBuild: number; armSize: number; legSize: number }) => {
  ...
  return { forty, bench, vertical, score };
};
