...
assert.ok(soloFeature.includes('/solo-universe-edition.webp')&&!soloFeature.includes('eli-rodriguez'), 'the Home Solo feature must use the owner-approved Universe Edition artwork');
