...
assert.ok(soloFeature.includes('Eli Rodriguez')===false&&soloFeature.includes('eli-rodriguez/card.webp')&&soloFeature.includes('solo-brk-02/card.webp')&&soloFeature.includes('solo-brk-30/card.webp')&&soloFeature.includes('solo-brk-05/card.webp'), 'the Home Solo feature must use approved optimized derivatives for Eli, QB, EDGE, and RB identities');
assert.ok(soloFeature.includes('loading="lazy"')&&soloFeature.includes('Build your legacy')&&soloFeature.includes('Play Solo'), 'the Solo feature must lazy-load its art and expose clear product copy');
